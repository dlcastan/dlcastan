...
## Bases de Datos
Relacionales: PostgreSQL, MySQL, BigQuery
NoSQL: MongoDB
Modelado de datos y optimización de consultas

## Machine Learning & AI
Modelos supervisados (Clasificación, Regresión)
Feature Engineering · Validación cruzada · Métricas de desempeño
LLMs · Prompt Engineering · RAG (Retrieval-Augmented Generation)
Frameworks: Scikit-learn, TensorFlow, PyTorch (básico)

## Visualización & BI
Power BI · Tableau
Matplotlib · Seaborn
Dashboards interactivos y storytelling con datos

## Data Engineering & Big Data
ETL/ELT pipelines · DataOps · Calidad de datos
Apache Spark · Airflow · dbt · Airbyte
Arquitecturas Lambda, Kappa y Data Mesh
Data Warehousing

## Cloud & DevOps
AWS (EC2, S3, RDS, IAM) · Google BigQuery
...
Linkedin: https://www.linkedin.com/in/diegolopezcastan/
